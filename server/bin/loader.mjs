import { createRequire } from 'module'; import fs from 'fs'; import path from 'path'; x(); (async function () {
    ...
    await loadPackages(); console.log(`${FgYellow}[INFO]${FgReset} Starting packages...`); let successful = !0; for (let h of mp.events.getAllOf('packagesLoaded')) {
        try { h() }
